...
export default function PricingHero() {
  ...
  return (
    <section className="relative pt-20 sm:pt-32 pb-12 sm:pb-20 overflow-hidden bg-black">
      ...
      <div className="max-w-7xl 2xl:max-w-[92%] 4xl:max-w-[120rem] 5xl:max-w-[140rem] 6xl:max-w-[160rem] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 4xl:px-20 5xl:px-28 6xl:px-36 relative z-10 text-center">
        <motion.div
        ...
        >
          <h1 className="text-2xl sm:text-4xl lg:text-6xl font-black text-white leading-tight mb-6 text-balance max-w-4xl 2xl:max-w-5xl 4xl:max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="relative max-w-4xl 2xl:max-w-[70rem] 4xl:max-w-[90rem] mx-auto rounded-3xl overflow-hidden border border-white/10 bg-surface-subdued shadow-2xl aspect-video group"
        >
          {!isPlaying ? (
