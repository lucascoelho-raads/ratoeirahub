...
function InputAnatomy({ mode }: { mode: InspectionMode }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <AnatomyCanvas>
        <div className="relative max-w-xl 2xl:max-w-[40rem] 4xl:max-w-[60rem] mx-auto">
      ...
      <div className="grid lg:grid-cols-[260px_1fr]">
        ...
        <main className="max-w-5xl 2xl:max-w-[90rem] 4xl:max-w-[100rem] 5xl:max-w-[120rem] 6xl:max-w-[140rem] mx-auto px-10 py-12 w-full space-y-14">
          <section id="overview" className="space-y-4">
            ...
            <p className="text-body-description text-text-secondary max-w-3xl 2xl:max-w-[60rem] 4xl:max-w-[80rem]">
