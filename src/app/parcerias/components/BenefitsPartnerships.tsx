...
export default function BenefitsPartnerships() {
  return (
    <section id="beneficios" className="py-16 md:py-24 bg-[#0a0a0a] relative scroll-mt-20">
          ...
          {benefits.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#111111] border border-white/10 rounded-[32px] p-6 sm:p-8 md:p-10 hover:border-brand-primary/30 transition-colors group text-center sm:text-left"
              >
                <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 mx-auto sm:mx-0 group-hover:bg-brand-primary/10 group-hover:border-brand-primary/30 transition-colors">
