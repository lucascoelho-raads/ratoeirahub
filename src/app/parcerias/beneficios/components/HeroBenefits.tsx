...
export default function HeroBenefits() {
  return (
    <section className="relative min-h-[100svh] overflow-hidden bg-[#050505] flex items-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-[clamp(5rem,10vh,9rem)]">
        <motion.div
        ...
        >
          ...
          <p className="text-[clamp(1.05rem,1.25vw,1.35rem)] text-gray-400 leading-relaxed max-w-3xl mx-auto">
