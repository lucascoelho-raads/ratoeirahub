  ...
  return (
    <main className="flex flex-col flex-1 min-h-screen bg-[#050505] text-white">
      ...
      <section className="relative pt-28 sm:pt-40 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl 2xl:max-w-[92%] 4xl:max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 4xl:px-20 text-center">
      ...
      <section className="relative z-10 pb-16 md:pb-32 px-4 sm:px-6 lg:px-8">
        ...
        {/* CTA Support */}
        <div className="mt-12 md:mt-20 max-w-3xl 2xl:max-w-[92%] 4xl:max-w-[80rem] mx-auto text-center bg-[#111111] border border-white/10 rounded-[32px] p-6 sm:p-10 md:p-16">
