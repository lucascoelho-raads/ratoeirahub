...
export default function TermosDeUsoAdsPage() {
  return (
    <main className="flex flex-col flex-1 min-h-screen bg-[#050505] text-white">
      ...
      <div className="flex-1 py-20 md:py-32 px-4 sm:px-6 lg:px-8 max-w-4xl 3xl:max-w-[70rem] 4xl:max-w-[90rem] 3xl:max-w-[70rem] 4xl:max-w-[90rem] mx-auto w-full">
        <div className="mb-12">
          <Link
            href="/"
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-4 tracking-tight">Termos de Uso</h1>
