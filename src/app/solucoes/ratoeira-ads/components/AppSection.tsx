...
export default function AppSection() {
  ...
  return (
    <section ref={ref} className="py-16 md:py-24 bg-[#f9fafb] relative overflow-hidden">
      ...
      <div className="max-w-6xl 2xl:max-w-[92%] 4xl:max-w-[110rem] 5xl:max-w-[130rem] 6xl:max-w-[150rem] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 4xl:px-20 5xl:px-28 6xl:px-36">
        <motion.div
        ...
        >
          ...
          <div className="flex-1 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#111827] leading-tight mb-6 text-balance">
              Que tal uma ratoeira no seu{" "}
              <span className="text-brand-primary">bolso</span>?
            </h2>
            <p className="text-base sm:text-lg text-[#4b5563] leading-relaxed max-w-xl 2xl:max-w-[50rem] 4xl:max-w-[60rem] mx-auto lg:mx-0 text-balance">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <div className="flex items-center gap-3 px-4 py-3 bg-white border border-black/10 rounded-xl">
                ...
                <span className="text-sm font-semibold text-[#374151]">Notificações em tempo real</span>
              </div>
              <div className="flex items-center gap-3 px-4 py-3 bg-white border border-black/10 rounded-xl">
                <div className="w-10 h-10 rounded-lg bg-brand-primary/20 flex items-center justify-center shrink-0">
                  <BarChart3 className="w-5 h-5 text-brand-primary" />
                </div>
                <span className="text-sm font-semibold text-[#374151]">Dashboard de vendas</span>
              </div>
            </div>
          </div>
