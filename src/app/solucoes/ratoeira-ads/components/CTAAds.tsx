  ...
  return (
    <section className="py-16 md:py-32 bg-[#050505] relative overflow-hidden flex flex-col items-center justify-center min-h-[auto] md:min-h-[clamp(700px,90vh,1100px)]">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10 opacity-60">
        <div className="relative flex h-[800px] w-full max-w-5xl 2xl:max-w-[92%] 4xl:max-w-[100rem] flex-col items-center justify-center space-y-4 overflow-visible px-4">
          {/* Row 1 */}
          <div className="mx-auto w-full max-w-4xl 2xl:max-w-[92%] 4xl:max-w-[90rem] absolute top-16">
          ...
          {/* Row 2 */}
          <div className="mx-auto w-full max-w-5xl 2xl:max-w-[92%] 4xl:max-w-[100rem] absolute top-1/2 -translate-y-1/2">
          ...
          {/* Row 3 */}
          <div className="mx-auto w-full max-w-4xl 2xl:max-w-[92%] 4xl:max-w-[90rem] absolute bottom-16">
            <div className="flex w-full items-center justify-center space-x-10 md:justify-between md:space-x-0">
              <IconContainer
                delay={0.6}
                text="Funil Completo"
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full px-4 text-center mt-8">
        <motion.div
          ...
          className="flex flex-col items-center w-full max-w-6xl 2xl:max-w-[92%] 4xl:max-w-[110rem] 5xl:max-w-[130rem] 6xl:max-w-[150rem] mx-auto"
        >
          <h2 className="text-[clamp(1.75rem,6vw,4.5rem)] font-black text-white mb-6 tracking-tight drop-shadow-[0_0_15px_rgba(0,0,0,0.8)] px-4 text-balance">
            Pare de tomar decisão com dado <span className="text-brand-primary">incompleto</span>.
          </h2>
          <p className="text-base sm:text-[clamp(1.1rem,1.25vw,1.5rem)] text-gray-300 max-w-3xl 2xl:max-w-[50rem] 4xl:max-w-[80rem] mx-auto drop-shadow-[0_0_10px_rgba(0,0,0,0.8)] leading-relaxed px-4 text-balance">
