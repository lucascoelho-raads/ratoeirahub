...
export default function MVVAbout() {
  ...
  return (
    <section id="manifesto" className="py-32 bg-[#050505] relative overflow-hidden">
      {/* Background Accent */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="bg-[#111111] p-8 rounded-3xl shadow-xl border border-white/10 hover:-translate-y-2 transition-transform duration-300"
          >
            <div className="w-14 h-14 bg-orange-500/15 border border-orange-500/20 rounded-2xl flex items-center justify-center mb-5">
          ...
          <motion.div
            ...
            className="bg-[#111111] p-8 rounded-3xl shadow-xl border border-white/10 hover:-translate-y-2 transition-transform duration-300"
          >
            <div className="w-14 h-14 bg-amber-500/15 border border-amber-500/20 rounded-2xl flex items-center justify-center mb-5">
