    ...
    <>
      {showTransformSection && (
        <section id="vamos-transformar" className={sectionClassName}>
          <AuroraBackground>
          <div className="max-w-7xl 3xl:max-w-[92%] mx-auto px-4 sm:px-6 lg:px-8 3xl:px-12 py-16 md:py-20 lg:py-24">
      ...
      <footer className="text-gray-400">
        <div className="max-w-7xl 3xl:max-w-[92%] mx-auto px-4 sm:px-6 lg:px-8 3xl:px-12">
          {/* Main footer */}
