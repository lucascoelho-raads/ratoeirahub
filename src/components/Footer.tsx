    ...
    <>
      {showTransformSection && (
        <section id="vamos-transformar" className={sectionClassName}>
          <AuroraBackground>
          <div className="max-w-7xl 2xl:max-w-[92%] 4xl:max-w-[120rem] 5xl:max-w-[140rem] 6xl:max-w-[160rem] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 4xl:px-20 5xl:px-28 6xl:px-36 py-16 md:py-20 lg:py-24">
