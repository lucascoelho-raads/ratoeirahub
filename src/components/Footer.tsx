            ...
            <div className="max-w-7xl 2xl:max-w-[90rem] 4xl:max-w-[120rem] 5xl:max-w-[140rem] 6xl:max-w-[160rem] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 4xl:px-20 5xl:px-28 6xl:px-36 py-16 md:py-20 lg:py-24">
              <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-[1.3fr_1fr] 3xl:grid-cols-[1.4fr_1fr] 4xl:grid-cols-[1.5fr_1fr] 5xl:grid-cols-[1.55fr_1fr] 6xl:grid-cols-[1.6fr_1fr] gap-14 lg:gap-20 5xl:gap-28 6xl:gap-36 items-center">
                <div className="max-w-xl 2xl:max-w-[36rem] 3xl:max-w-[48rem] 4xl:max-w-[64rem] 5xl:max-w-[80rem] 6xl:max-w-[96rem] text-center lg:text-left mx-auto lg:mx-0">
                  <h2
                    className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[0.98] hyphens-none ${titleBaseClassName}`}
                  >
                    <span className="inline-block whitespace-nowrap">
                      Vamos <span className="text-orange-500">estruturar</span>
                    </span>{" "}
                    <span className="inline-block whitespace-nowrap">
                      sua operação?
                    </span>
                  ...
                  <p
                    className={`mt-7 text-base sm:text-lg leading-relaxed ${subtitleClassName}`}
                  >
                    Preencha seu cadastro. Ative agora mesmo seu plano{" "}
                    <span className="text-orange-500 font-bold">GRATUITO</span>.
                    Sem cartão, sem pix. Apenas cadastre-se e receba o acesso.
                  </p>
                </div>

                <div
                  className={`mx-auto w-full max-w-xl 3xl:max-w-[40rem] 4xl:max-w-[60rem] 5xl:max-w-[70rem] 6xl:max-w-[80rem] rounded-[28px] p-8 sm:p-10 5xl:p-12 6xl:p-14 ${cardClassName}`}
                >
                  <form
                    noValidate
                    onSubmit={(e) => {
                    ...
                    {step === 1 && (
                      <>
                        <div className="space-y-2">
                          <label
                            className={`text-sm font-bold ${labelClassName}`}
                          >
                            Nome Completo
                          </label>
                          <input
                        ...
                        <div className="space-y-2">
                          ...
                          >
                            {selectedCountry.flag} {selectedCountry.name} · DDI{" "}
                      ...
                      <>
                        <div className="space-y-2">
                          ...
                          >
                            ...
                            <option value="Dono de Negócio Local">
                            ...
                            <option value="Ainda Não Comecei">
                              Ainda Não Comecei
                            </option>
                          </select>
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setMainTrafficSource(e.target.value)
                            }
                            className={`w-full appearance-none rounded-2xl border px-5 py-4 text-base outline-none focus:ring-2 ${inputClassName}`}
                          >
                            <option value="" disabled>
                            ...
                            <option value="Native Ads (Taboola/Outbrain)">
