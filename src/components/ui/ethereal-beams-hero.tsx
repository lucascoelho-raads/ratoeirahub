...
export const BeamsBackground: FC<{
  children: ReactNode
  className?: string
  beamsProps?: BeamsProps
}> = ({ children, className = "", beamsProps }) => {
  return (
  ...
  return (
    <BeamsBackground
      ...
      beamsProps={{
        ...
        beamHeight: 20,
        beamNumber: 15,
        lightColor: "#facc15", // Tailwind yellow-400 (gold-400)
        speed: 1.5,
        noiseIntensity: 2,
        scale: 0.15,
        rotation: 45,
    ...
    >
      <div className="flex flex-col items-center justify-center min-h-screen px-4 pt-[clamp(7rem,16vh,12rem)] pb-[clamp(4.5rem,10vh,8.5rem)]">
        {/* Hero Content */}
        <div className="max-w-6xl 2xl:max-w-[50rem] 3xl:max-w-[70rem] 4xl:max-w-[90rem] 5xl:max-w-[110rem] 6xl:max-w-[130rem] text-center">
          <motion.h1
          ...
          <motion.p
            ...
            className="text-[clamp(1.05rem,1.25vw,1.35rem)] text-gray-50 mb-12 max-w-3xl 2xl:max-w-[44rem] 3xl:max-w-[60rem] 4xl:max-w-[80rem] 5xl:max-w-[100rem] 6xl:max-w-[120rem] mx-auto text-balance"
          >
          ...
          >
            <div className="relative mx-auto h-[clamp(14rem,30vw,28rem)] 5xl:h-[clamp(16rem,25vw,36rem)] 6xl:h-[clamp(18rem,22vw,42rem)] w-full max-w-5xl 3xl:max-w-[80rem] 4xl:max-w-[100rem] 5xl:max-w-[120rem] 6xl:max-w-[140rem] rounded-2xl border border-white/10 bg-black/20 shadow-2xl shadow-black/60 overflow-hidden">
              <Image
                src="/dashboard.png"
