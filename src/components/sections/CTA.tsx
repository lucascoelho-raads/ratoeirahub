    ...
    >
      ...
      <div className="relative max-w-6xl 2xl:max-w-[92%] 4xl:max-w-[110rem] 5xl:max-w-[130rem] 6xl:max-w-[150rem] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 4xl:px-20 5xl:px-28 6xl:px-36 text-center">
        ...
        >
          ...
          {/* Title */}
          <h2 className="text-2xl sm:text-4xl lg:text-5xl 3xl:text-7xl font-black text-[#111827] leading-tight text-balance max-w-4xl 5xl:max-w-6xl 6xl:max-w-[80rem] mx-auto">
          ...
          {/* Subtitle */}
          <p className="text-[#4b5563] text-base sm:text-lg 3xl:text-3xl max-w-2xl 2xl:max-w-[40rem] 3xl:max-w-[56rem] 4xl:max-w-[72rem] 5xl:max-w-[90rem] 6xl:max-w-[110rem] mx-auto leading-relaxed text-balance">
